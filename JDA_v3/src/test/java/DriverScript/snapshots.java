...
public class snapshots extends DififoReportSetup{
	...
	public void DDEPROFILE_Validation() throws IOException, SQLException, InterruptedException 
	{
		...
		db.WIP_SAP_SUPERSESSION(Query);
		int rowMax = exfile.getTotalRowColumn(testScenarioFilePath,testCaseFileName,InputfromWIP);
		...
		String DMDunit = fetchItemNumber(testScenarioFilePath,testCaseFileName,InputfromWIP,i,0);
		String DDEloc = fetchLocationNumber(testScenarioFilePath,testCaseFileName,InputfromWIP,i,2);
	...
	public void DFUMOVINGEVENTMAP() throws IOException, SQLException, InterruptedException 
	{
		...
		String DMDunit = fetchItemNumber(testScenarioFilePath,testCaseFileName,InputfromWIP,i,0);
		String eventloc = fetchLocationNumber(testScenarioFilePath,testCaseFileName,InputfromWIP,i,2);
	...
	public void FCST() throws IOException, SQLException, InterruptedException 
	{
		...
		String DMDunitparent = fetchItemNumber(testScenarioFilePath,testCaseFileName,InputfromWIP,i,1);
		String eventloc = fetchLocationNumber(testScenarioFilePath,testCaseFileName,InputfromWIP,i,2);
		...
		String DMDunitchild = fetchItemNumber(testScenarioFilePath,testCaseFileName,InputfromWIP,i,0);
