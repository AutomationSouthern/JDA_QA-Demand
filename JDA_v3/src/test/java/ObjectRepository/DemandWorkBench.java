...
public class DemandWorkBench {
	...
	String DMDGROUP;
	String LOC;
    By inputDMDUNIT = By.xpath("//*[@id='PopupAppDiv']/form/table[2]/tbody/tr[6]/td[3]/input");
    By inputDMDGROUP = By.xpath("//*[@id='PopupAppDiv']/form/table[2]/tbody/tr[8]/td[3]/input");
    By inputLOC = By.xpath("//*[@id='PopupAppDiv']/form/table[2]/tbody/tr[12]/td[3]/input");
    By Done =By.xpath("//span[@id='PromptScreenPopup_doneBtnOn']/div/a/div/div[@class='j-button-fill']/span[text()='Done']");
    By Dropdown = By.xpath("//*[@title='Demand Workbench - Public']");
